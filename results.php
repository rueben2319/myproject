	...
	<div class="card" style="border-radius: 0;">
		...
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-success btn-sm" href="./index.php?page=new_result"><i class="fa fa-plus"></i> Add New</a>
			</div>
		</div>
	<?php endif; ?>
		<div class="card-body">
						...
						<td class="text-center">
		                    ...
		                    <div class="btn-group">
		                        <a href="./index.php?page=edit_result&id=<?php echo $row['id'] ?>" class="btn btn-primary btn-flat">
		                         ...
		                         <button href="./index.php?page=view_result&id=<?php echo $row['id'] ?>" type="button" class="btn btn-info btn-flat view_result">
